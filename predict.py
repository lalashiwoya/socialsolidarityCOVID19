...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default='reviewer',
                        help="Directory which saves data to be predicted")
    parser.add_argument("--output_dir", type=str, default='reviewer/output', help="Path to save the prediction results")
